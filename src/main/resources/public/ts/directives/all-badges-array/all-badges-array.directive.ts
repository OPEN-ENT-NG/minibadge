...
function directive(): IDirective {
    return {
        replace: true,
        restrict: 'E',
        templateUrl: `${RootsConst.directive}/all-badges-array/all-badges-array.html`,
        scope: {
            badges: '=',
            filterFunction: '&'
        },
...
export const minibadgeAllBadgesArray = ng.directive('minibadgeAllBadgesArray', directive);